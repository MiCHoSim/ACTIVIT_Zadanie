...
class Validator
{
    ...
    const PATTERN_ALL_STRING = array('description' => 'Enter a string of at least 2 characters',
        'pattern' => '^[a-žA-Ž_]+( [a-žA-Ž_]+)*$'); // Pattern  ostatne stringy
    ...
    const PATTERN_IBAN = array('description' => 'Enter your iban.',
        'pattern' => '^([A-Z]{2}[ \-]?[0-9]{2})(?=(?:[ \-]?[A-Z0-9]){9,30}$)((?:[ \-]?[A-Z0-9]{3,5}){2,7})([ \-]?[A-Z0-9]{1,3})?$'); // Pattern pre IBAN
