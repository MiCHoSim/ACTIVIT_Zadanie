...
class Form
{
    ...
    {
        $this->addInput('Street', self::STREET, Input::TYPE_TEXT,'', '', $this->inputAtrClas, $this->inputAtrClasLabel,true, Validator::PATTERN_ALL_STRING);
    }
    /**
    ...
    {
        $this->addInput('City', self::CITY, Input::TYPE_TEXT,'', '', $this->inputAtrClas, $this->inputAtrClasLabel,true,Validator::PATTERN_ALL_STRING);
    }
    /**
    ...
    /**
     * Objekt Kontrolky - Input iban
     */
    private function setIban()
    {
        $this->addInput('Iban', self::IBAN, Input::TYPE_TEXT,'', '', $this->inputAtrClas, $this->inputAtrClasLabel,true, Validator::PATTERN_IBAN,false,'onkeyup="validateIban()"');
    }
    /**
     ...
     * @return void
     */
    public function addInput(string $name, string $nameDb, string $type , string $value = '', string $form = '', string $atrClas = '', string $atrClasLabel = '', bool $required = true, array|bool $pattern = false, bool $disabled = false, string|bool $attributes = false)
    {
