...
class DateTimeUtilities
{
     ...
     * @param StringUtilities $datumCas Dátum čas
     ...
     * @param DateTimeUtilities $datum Dátum typu DateTime
     * @return StringUtilities Názov mesiaca v slovenčine
     */
    public static function mesiacSlovne(DateTimeUtilities $datum)
    {
    ...
    /**
     ** Zaokruhli aktualny dátum a čas na celé hodiny
     * @return string
     */
    public static function roundActualHour() : string
    {
        $dateTime = new DateTime();
        $minute = $dateTime->format('i');
        $hour = $dateTime->format('H');
        $time = $minute >= 30 ? ++$hour . ':00' : $hour . ':00';
        return $dateTime->format('Y-m-d') . 'T' . $time;
    }
